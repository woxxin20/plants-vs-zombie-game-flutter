...
| `TASK-008` | N/A (infra) | `lib/core/theme.dart` | Color/text tokens defined as plain `Color`/`TextPaint` constants per spec §10.1/§26; zero `ThemeData` references | `grep -c "ThemeData" lib/core/theme.dart` returns 0 | Not started |
