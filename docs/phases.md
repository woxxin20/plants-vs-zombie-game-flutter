...
| `PH-02` | Shadow walk/eat + beam trace (mirror/prism) + collisions + HP bars + sweep + win/lose overlays, one full level playable | Spec §25 Phase 2, §7, §8, §15, §16 | `PH-01` | **Closed** — `PH-02-G1` passed on emulator-5554 (c16): level 1 played start to VICTORY, Pause/Resume/Win overlays all mounted and interactive, progress persisted. `AUD-024` closed | 2026-09-09, GameDesigner (lead) |
...
| `PH-05` | Multi-viewport + profiled 60fps (ads/IAP withdrawn) | Spec §25 Phase 5, §20 | `PH-04` | Rescoped — `PRD-FR-016/017/018` withdrawn from v1 by owner decision 2026-09-09; v1 ships free and unmonetised. Only multi-viewport and profiled 60fps remain | 2026-09-09, GameDesigner (lead) |
